 ...
 * Returns: True if key belongs to array, False if key doesn't belong to array
 */
 ...
 * Returns: an index in range [0, n-1] if key belongs to array, -1 if key
 * doesn't belong to array
 */
 ...
 * array, -1 if key is the greatest element in array
 */
